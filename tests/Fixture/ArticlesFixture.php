...
class ArticlesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'img_url' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'article_url' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'article_url' => 'Lorem ipsum dolor sit amet',
                'user_id' => 1,
                'created' => '2022-10-27 03:38:41',
                'modified' => '2022-10-27 03:38:41',
            ],
        ];
        parent::init();
    }
